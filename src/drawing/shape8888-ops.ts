...
) => line(start, end, (pt) => bitmap8888.putPixelMut(bmp, pt, color))
...
) => ellipse(start, end, (pt) => bitmap8888.putPixelMut(bmp, pt, color))
...
) => rectangle(start, end, (pt) => bitmap8888.putPixelMut(bmp, pt, color))
...
export const drawShape8888 = {
    ellipse: drawEllipse,
    line: drawLine,
    rectangle: drawRectangle,
} as const

export const putShape8888 = {
    ellipse: putEllipse,
    line: putLine,
